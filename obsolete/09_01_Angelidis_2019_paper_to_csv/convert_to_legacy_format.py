#!/usr/bin/env python3
"""
Step 3: Filter ECM and convert to LEGACY format (merged_ecm_aging_zscore.csv)
"""
...
def main():
    ...
    # 2. Organ (from Tissue - for Angelidis it's "Lung")
    df_wide['Organ'] = 'Lung'  # From config

    # 3. Compartment (for Angelidis without compartments = same as Tissue)
    df_wide['Compartment'] = 'Lung'  # No compartments
    ...
    output_file = "Angelidis_2019_LEGACY_format.csv"
